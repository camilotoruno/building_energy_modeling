...
if __name__ == '__main__':
    ...
    restock_folder = "/Users/camilotoruno/resstock-euss.2022.1-2"
    openstudio_workflow = "custom-run-hpxml.osw"
    
    hpxml_measures_folder = os.path.join(restock_folder, "resources", "hpxml-measures")
    ...
    args = {
            ...
            "buildstock_output_file": "full_buildstock_24.02.27-multiprocessing.csv",
